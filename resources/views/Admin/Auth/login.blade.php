					...
					<div class="left">
						<div class="content">
                            ...
                            @csrf
								...
								<div class="bottom">
									Not a Member? <span class="helper-text"><a href="{{ route('register') }}">SignUp</a></span>
								</div>
								<div class="bottom">
								Forgot password <span class="helper-text"><a href="{{ route('forgotpassword') }}">Click Here</a></span>
								</div>
							</form>
						</div>
					</div>
